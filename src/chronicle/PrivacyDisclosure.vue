...
<template>
    ...
    >
        <div class="w-[32rem] max-w-[90vw] bg-mz-panel border border-mz-edge shadow-balcony p-6 flex flex-col gap-4">
            <header>
                <div class="mz-stamp-label">First boot — one-time notice</div>
                <h2 class="font-display text-mz-text text-lg tracking-wide mt-1">The Chronicle</h2>
            </header>
            <div class="text-sm text-mz-text-mute font-display leading-relaxed space-y-3">
                <p>
                    Every pty turn (your input + the bench's output) will be appended to a local JSONL file under
                    <span class="font-mono text-mz-stamp">~/.zmuuzn-cockpit/transcripts/</span>. A new file is rotated
                ...
                <p>
                    ...
                    <span class="font-mono text-mz-stamp">.gitignore</span> as a defensive layer.
                </p>
                <p>
            ...
            <p v-if="disclosure.lastError.value" class="text-mz-pulse-crashed font-mono text-xs">
                {{ disclosure.lastError.value }}
            </p>
            <div class="flex justify-end pt-2">
                <button
                    type="button"
                    class="mz-button border-mz-brass text-mz-brass"
                    data-disclosure-ack
